...
describe("voting-program", () => {
  ...
  it("Initialize Poll", async () => {
    ...
    // console.log(poll);
    expect(poll.pollId).equals(1);
    expect(poll.description).equals("What is your favourite food?");
    expect(poll.endTime.toNumber()).greaterThan(poll.startTime.toNumber());
  });
  ...
  it("Initialize Candidate", async () => {
    ...
    expect(candiate1.candidateName).equals("biriyani");
    expect(candiate2.candidateName).equals("tea");
    expect(candiate1.votingCount.toNumber()).equals(0);
    expect(candiate2.votingCount.toNumber()).equals(0);
  });
  ...
  it("vote", async () => {
    ...
    expect(candiate1.votingCount.toNumber()).equals(1);
    ...
    const candiate2 = await votingProgram.account.candidate.fetch(teaAddress);
    expect(candiate2.votingCount.toNumber()).equals(1);
